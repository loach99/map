...
import { loginFailure, loginRequest, loginSuccess } from "../../authReducer/actions/actions";
...
export const getGraphics = (token: string, date_start: string, date_end: string): any => {
